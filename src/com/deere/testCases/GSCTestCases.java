...
public class GSCTestCases extends CoreTestCase {
	...
	public static void test_TC6333_GSCRouting(InputEnvironmentDetails inputEnvironmentDetails,
		...
		// button
		gscRoutingPage = functionalMethods.gscCaseCreationDetailsRoute(gscRoutingPage, testData.getTestdata()[4],
	...
	public static void test_TC6541_GSCRoutingFilterSearch(InputEnvironmentDetails inputEnvironmentDetails,
		...
		// Entering GSC Case Creation All Mandatory fields data and click on submit
		// button
		gscRoutingPage = functionalMethods.gscCaseCreationDetailsFilterSearch(gscRoutingPage, testData.getTestdata()[4],
	...
	public static void test_TC6849_GSCRoutingNegitive(InputEnvironmentDetails inputEnvironmentDetails,
		...
		gscRoutingPage = functionalMethods.caseCreationDetails(gscRoutingPage, testData.getTestdata()[4],
				testData.getTestdata()[5], testData.getTestdata()[16], testData.getTestdata()[6],
				testData.getTestdata()[7], testData.getTestdata()[8], testData.getTestdata()[9],
				 testData.getTestdata()[11], testData.getTestdata()[17]);
		...
		gscRoutingPage = functionalMethods.selectWorkCaseFrmActionsDDGSC(gscRoutingPage);
	...
	public static void test_TC6540_AuditTrailDetails(InputEnvironmentDetails inputEnvironmentDetails,
		...
		gscCustomerSearch = functionalMethods.clickOnActionsTIndividual(gscCustomerSearch, testData.getTestdata()[14],
				testData.getTestdata()[15]);
...
//		 assertTrue(homePage.hasMyTerritoryDisplayed(), " My Territory is not displayed");
		
//		 //Verify that correct category is displayed
//		 assertTrue(homePage.hasMyCasesDisplayed(), "My Cases is not displayed");
//		
//		 //Verify that correct category is displayed
//		 assertTrue(homePage.hasCaseSearchDisplayed(), "Case search is not displayed");
//		
//		 //Verify that correct category is displayed
...
//		 //Verify that correct category is displayed
//		 assertTrue(homePage.hasGSCCaseDisplayed(), "Create GSC Case is not displayed");
//		
//		 //Verify that correct category is displayed
//		 assertTrue(homePage.hasISGCaseDisplayed(), "Create ISG Case is not displayed");
//		
//		 //Verify that correct category is displayed
//		 assertTrue(homePage.hasGSCReportCaseDisplayed(), "Create GSC R4 Case Report only is not displayed");
//		
//		 //Verify that correct category is displayed
//		 assertTrue(homePage.hasGreenFleetCaseDisplayed(), "GreenFleet case is not displayed");
		...
		assertTrue(gscR4Page.hasSubmitDisplayed(), "Submit button is not displayed");
		 ...
		 assertTrue(gscR4Page.hasProblemDetailsDisplayed(), "Problem Details is not displayed");
		
		 //validate Summary
		 assertTrue(gscR4Page.hasSummaryDisplayed(), "Summary is not displayed");
		
		 //validate workBasket
		 assertTrue(gscR4Page.hasWorkBasketDisplayed(), "workBasket is not displayed");
		
		 //validate case type
		 assertTrue(gscR4Page.hasCaseTypeDisplayed(), "case type is not displayed");
		
		 //validate case subtype Agcc
		 assertTrue(gscR4Page.hasCaseTypeValueR4AgccDisplayed(), "case subtype Agcc is  not displayed");
		
		 //validate case subtype Turf
		 assertTrue(gscR4Page.hasCaseTypeValueR4TurfDisplayed(), "case subtype Turf is not displayed");
		
		 //validate CCC Case number
		 assertTrue(gscR4Page.hasCCCCaseNumberDisplayed(), "CCC Case number is not  displayed");
		
		 //validate Comments
		 assertTrue(gscR4Page.hasCommentsDisplayed(), "Comments is not displayed");
		
		 //validate Internal Comments
		 assertTrue(gscR4Page.hasInternalCommentsDisplayed(), "Internal Comments is not displayed");
		...
		gscCaseCreationPage = functionalMethods.gscSearchCustomerDetailsReportVerification(gscCaseCreationPage,
				...
				testData.getTestdata()[13], testData.getTestdata()[14],testData.getTestdata()[15]);
		...
		// Enter the CaseId
		isgCaseSearchPage = functionalMethods.enterCaseId(isgCaseSearchPage);
