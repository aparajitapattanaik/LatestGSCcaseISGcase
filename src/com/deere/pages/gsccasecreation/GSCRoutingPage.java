...
public class GSCRoutingPage extends GlobalThings{
	...
	@FindBy(xpath = "(//*[contains(text(),'Case Coding')])[2]")
	private WebElement caseCodingSct;

	@FindBy(xpath = "//*[contains(text(),'Case Information')]")
	...
	@FindBy(xpath = "//*[contains(text(),'Problem Details')]")
	...
	@FindBy(xpath = "//button[@data-test-id='20141009112850013521365']")
	private WebElement actions;
	
	@FindBy(xpath = "//button[@data-test-id='2014100911285001362285']")
	private WebElement actionsGSC;

	@FindBy(xpath = "//*[@id='pyNavigation1524580063140' or @id='pyNavigation1528360059959']")
	private WebElement actionsFrame;
	
	@FindBy(xpath = "//*[@id='pyNavigation1524580063101']")
	private WebElement actionsFrameGsc;

	@FindBy(xpath = "//*[@id='pyNavigation1524580063140']/li[3]")
	...
	@FindBy(xpath = "//*[@id='pyNavigation1524580063101']/li[2]")
	private WebElement workCaseGsc;
	...
	public GSCRoutingPage clickonWorkCaseGSC() {
		CommonFunctions.waitForElement(driver, actionsGSC).click();
		CommonFunctions.waitForElement(driver, actionsFrameGsc);
		CommonFunctions.waitForElement(driver, workCaseGsc).click();
		return new GSCRoutingPage(driver);
