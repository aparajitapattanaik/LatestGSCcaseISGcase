...
public class GSCCaseCreationPage {
	...
	@FindBy(xpath = " //select[@data-test-id='20180420090331023614765']")
	private WebElement gscPriority;

	@FindBy(xpath = "//select[@data-test-id='20180420090339039118414']")
	...
	@FindBy(xpath = "//select[@data-test-id='20180424083621000521988']")
	private WebElement caseTypeFiled;
	...
	public GSCCaseCreationPage selectCaseType(String caseType) {
		try {
			Thread.sleep(3000);
		...
		CommonFunctions.selectFromDropdown(driver, caseType, caseTypeFiled);
		//CommonFunctions.selectFromDropdown(driver, caseType, caseTypeFiled);

		return new GSCCaseCreationPage(driver);
	}
	public GSCCaseCreationPage clickOnSaveBtn() {
		try {
			Thread.sleep(3000);
		} catch (Exception e) {
			e.printStackTrace();
		}
		CommonFunctions.waitForElement(driver, saveButton).click();
		return new GSCCaseCreationPage(driver);
	}
